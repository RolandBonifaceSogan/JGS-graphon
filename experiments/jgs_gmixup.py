...
jgs_src = os.path.join(project_root, 'src')
gmixup_src = os.path.join(project_root, 'experiments', 'g-mixup', 'src')


for p in [gmixup_src, jgs_src]:
...
if __name__ == '__main__':
    ...
    if gmixup == True:
        ...
        for label, graphs in class_graphs:
                ...
                logger.info(f"ge: {ge}")
                estim= joint_graph_sorting_estimate(align_graphs_list, smoothing=True)
                graphon= estim["edge_frequencies"]
